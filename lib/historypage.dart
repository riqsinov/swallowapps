      ...
      image: DecorationImage(
        ...
        child: Stack(children: [
          ...
          Positioned(bottom: 35, top: 150, left: 10,
            child: Column(
              children: [
                Text("History", style: TextStyle(fontSize: 36, color: Colors.white)),
              ],
            ),),

          Positioned(bottom: 35, top: 300,left: 30,right: 30,
              child: Table(
                ...
                children: [
                  TableRow(children: [
                    ...
                    Column(children:[Text('Temperature &  Humidity', style: TextStyle(fontSize: 20.0))]),
                  ]),
                ],
              ))
        ],),
